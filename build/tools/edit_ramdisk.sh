...
echo "write /sys/kernel/cpu_input_boost/enabled \"$TBST\"" >> $CONFIGFILE
...
echo "" >> $CONFIGFILE
echo "# ARCH POWER" >> $CONFIGFILE
echo "write /sys/kernel/sched/arch_power 0" >> $CONFIGFILE
echo "" >> $CONFIGFILE
echo "# ENABLE CORE CTL" >> $CONFIGFILE
...
echo "" >> $CONFIGFILE
echo "# RUN SPECTRUM SERVICE" >> $CONFIGFILE
echo "setprop spectrum.run 1" >> $CONFIGFILE
